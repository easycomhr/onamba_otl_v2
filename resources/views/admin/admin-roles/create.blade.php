...
@section('title', __('ui.admin_role.create_title'))
@section('page_title', __('ui.admin_role.create_title'))
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="bg-gray-50 px-5 py-4 border-b border-gray-200">
            <h2 class="text-[17px] font-bold text-gray-800 uppercase tracking-wide">{{ __('ui.admin_role.create_title') }}</h2>
        </div>

        <form method="POST" action="{{ route('admin.admin-roles.store') }}" class="p-5 space-y-6">
            @csrf
